  ...
  <div className="away__score">{awayScore}</div>
      ...
      <section className="buttons">
        ...
        <div className="awayButtons">
          <button onClick = {awayFieldGoal} className="awayButtons__touchdown">Away Touchdown</button>
          <button onClick = {awayTouchDown} className="awayButtons__fieldGoal">Away Field Goal</button>
        </div>
      </section>
    </div>
  )
